...
# Erstellen der Batches mit den unterschiedlichen Größen, die getestet werden sollen.
train_Batch1= t.utils.data.DataLoader(Train_Data , batch_size= 8,shuffle = True)
test_Batch1 = t.utils.data.DataLoader(Test_Data , batch_size= 8,shuffle = False)

train_Batch2= t.utils.data.DataLoader(Train_Data , batch_size= 32,shuffle = True)
test_Batch2 = t.utils.data.DataLoader(Test_Data , batch_size= 32,shuffle = False)

train_Batch3= t.utils.data.DataLoader(Train_Data , batch_size= 128,shuffle = True)
test_Batch3 = t.utils.data.DataLoader(Test_Data , batch_size= 128,shuffle = False)

train_Batch4= t.utils.data.DataLoader(Train_Data , batch_size= 512,shuffle = True)
test_Batch4 = t.utils.data.DataLoader(Test_Data , batch_size= 512,shuffle = False)
...
# Definition der Funktion zum Trainieren und Testen des CNN
...
# Initialisierung und Durchführung der Tests
model1 = CNN()
optimizer = t.optim.Adam(model1.parameters(), lr=0.001)
loss_function = t.nn.CrossEntropyLoss()
relTest1,relTrain1,lTest1,lTrain1 = training_loop(10,optimizer,model1,loss_function,train_Batch1,test_Batch1)

model2 = CNN()
optimizer = t.optim.Adam(model2.parameters(), lr=0.001)
loss_function = t.nn.CrossEntropyLoss()
relTest2,relTrain2,lTest2,lTrain2 = training_loop(10,optimizer,model2,loss_function,train_Batch2,test_Batch2)

model3 = CNN()
optimizer = t.optim.Adam(model3.parameters(), lr=0.001)
loss_function = t.nn.CrossEntropyLoss()
relTest3,relTrain3,lTest3,lTrain3 = training_loop(10,optimizer,model3,loss_function,train_Batch3,test_Batch3)

model4 = CNN()
optimizer = t.optim.Adam(model4.parameters(), lr=0.001)
loss_function = t.nn.CrossEntropyLoss()
relTest4,relTrain4,lTest4,lTrain4 = training_loop(10,optimizer,model4,loss_function,train_Batch4,test_Batch4)
...
plt.legend([ 'Batch 8','Batch 32','Batch 128','Batch 512'],loc = 'lower left')
plt.title("Verlauf der Verlustfunktion")
plt.ylim(0,2.15)
plt.savefig("Loss_Batchtest.png")
plt.show()
...
plt.legend([ 'Batch 8','Batch 32','Batch 128','Batch 512' ],loc = 'upper left')
plt.title("Relative Genauigkeit")
plt.ylim(0,1)
plt.savefig("Rel_Batchtest.png")
plt.show()