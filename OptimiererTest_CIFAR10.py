...
# Laden der Daten
Train_Data = datasets.CIFAR10('data',train = True, download = True, transform=transforms.Compose( [transforms.RandomRotation(degrees=30),transforms.RandomVerticalFlip(p=0.5),transforms.ToTensor(), transforms.Normalize(( 0.5 , 0.5, 0.5) , (0.5, 0.5, 0.5)) ]))
...
plt.savefig("Loss_Train_CIFAR10.png")
plt.show()
...
plt.legend([ 'SGD','SGD mit Momentum','RMSprop','Adam' ],loc = 'upper right')
plt.title("Test loss")
plt.savefig("Loss_Test_CIFAR10.png")
plt.show()
...
plt.savefig("Acc_Test_CIFAR10.png")
plt.show()
...
plt.savefig("Acc_Train_CIFAR10.png")
plt.show()
